...
export class CollisionService {
  ...
  async checkPriorityCollision(
    ...
    // Find if this user is already queued for a higher-priority campaign
    // in the same group (lower priority number = higher priority)
   ...
   * More efficient than individual checks for large audiences
   */
   ...
   * Called right before actually sending the email
   */
  async checkCollisionAtSendTime(
    ...
    // This is a simplified version of checkCollision
    // Used as a final safety check before sending
