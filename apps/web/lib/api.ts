...
export const analytics = {
  ...
  getDailyMetrics: (days = 30) => request<DailyMetric[]>('/analytics/daily', { params: { days } }),
  getRecentCampaigns: (limit = 10) => request<RecentCampaign[]>('/analytics/recent-campaigns', { params: { limit } }),
  getCampaignStats: (id: string) => request<unknown>(`/analytics/campaigns/${id}`),
  getSkipReasons: (days = 7) => request<unknown>('/analytics/skip-reasons', { params: { days } }),
};
...
export const campaigns = {
  ...
  create: (data: Omit<CreateCampaignDto, 'workspaceId'>) =>
    request<Campaign>('/single-sends', { method: 'POST', body: { ...data, workspaceId: WORKSPACE_ID } }),
  update: (id: string, data: UpdateCampaignDto) =>
    request<Campaign>(`/single-sends/${id}`, { method: 'PATCH', body: data }),
  delete: (id: string) => request<void>(`/single-sends/${id}`, { method: 'DELETE' }),
  trigger: (id: string) => request<CampaignRun>(`/single-sends/${id}/trigger`, { method: 'POST', body: {} }),
};
...
export const campaignGroups = {
  ...
  create: (data: Omit<CreateCampaignGroupDto, 'workspaceId'>) =>
    request<CampaignGroup>('/campaign-groups', { method: 'POST', body: { ...data, workspaceId: WORKSPACE_ID } }),
  update: (id: string, data: Partial<Omit<CreateCampaignGroupDto, 'workspaceId'>>) =>
    request<CampaignGroup>(`/campaign-groups/${id}`, { method: 'PATCH', body: data }),
  delete: (id: string) => request<void>(`/campaign-groups/${id}`, { method: 'DELETE' }),
};
...
export const segments = {
  ...
  create: (data: Omit<CreateSegmentDto, 'workspaceId'>) =>
    request<Segment>('/segments', { method: 'POST', body: { ...data, workspaceId: WORKSPACE_ID } }),
  update: (id: string, data: Partial<Omit<CreateSegmentDto, 'workspaceId'>>) =>
    request<Segment>(`/segments/${id}`, { method: 'PATCH', body: data }),
  delete: (id: string) => request<void>(`/segments/${id}`, { method: 'DELETE' }),
  dryRun: (id: string, limit = 10) =>
    request<{ count: number; sample: unknown[] }>(`/segments/${id}/dry-run`, { method: 'POST', body: { limit } }),
};
...
export const templates = {
  ...
  create: (data: Omit<CreateTemplateDto, 'workspaceId'>) =>
    request<Template>('/templates', { method: 'POST', body: { ...data, workspaceId: WORKSPACE_ID } }),
  ...
  // Version operations
  createVersion: (templateId: string, data: Omit<TemplateVersion, 'id' | 'templateId' | 'version' | 'createdAt'>) =>
    request<TemplateVersion>(`/templates/${templateId}/versions`, { method: 'POST', body: data }),
  activateVersion: (templateId: string, versionId: string) =>
    request<TemplateVersion>(`/templates/${templateId}/versions/${versionId}/activate`, { method: 'POST', body: {} }),
};
...
export interface Component {
  ...
  content: string;
  variables: Array<{ name: string; type: string; defaultValue?: string; description?: string }>;
...
export const components = {
  ...
  create: (data: Omit<CreateComponentDto, 'workspaceId'>) =>
    request<Component>('/components', { method: 'POST', body: { ...data, workspaceId: WORKSPACE_ID } }),
  update: (id: string, data: Partial<Omit<CreateComponentDto, 'workspaceId'>>) =>
    request<Component>(`/components/${id}`, { method: 'PATCH', body: data }),
  delete: (id: string) => request<void>(`/components/${id}`, { method: 'DELETE' }),
};
...
export const dataConnectors = {
  ...
  get: (id: string) => request<DataConnector>(`/data-connectors/${id}`),
  create: (data: Omit<CreateDataConnectorDto, 'workspaceId'>) =>
    request<DataConnector>('/data-connectors', { method: 'POST', body: { ...data, workspaceId: WORKSPACE_ID } }),
  update: (id: string, data: Partial<Omit<CreateDataConnectorDto, 'workspaceId'>>) =>
    request<DataConnector>(`/data-connectors/${id}`, { method: 'PATCH', body: data }),
  delete: (id: string) => request<void>(`/data-connectors/${id}`, { method: 'DELETE' }),
  test: (id: string) => request<{ success: boolean; error?: string }>(`/data-connectors/${id}/test`, { method: 'POST', body: {} }),
};
...
export const senderProfiles = {
  ...
  create: (data: Omit<CreateSenderProfileDto, 'workspaceId'>) =>
    request<SenderProfile>('/sender-profiles', { method: 'POST', body: { ...data, workspaceId: WORKSPACE_ID } }),
  update: (id: string, data: Partial<Omit<CreateSenderProfileDto, 'workspaceId'>>) =>
    request<SenderProfile>(`/sender-profiles/${id}`, { method: 'PATCH', body: data }),
  delete: (id: string) => request<void>(`/sender-profiles/${id}`, { method: 'DELETE' }),
};
