...
const mockGroups = [
  {
    id: '1',
    name: 'Activation Emails',
    description: 'User activation and engagement campaigns',
  ...
  },
  {
    id: '2',
    name: 'Billing Alerts',
    description: 'Payment and subscription related emails',
    collisionPolicy: 'HIGHEST_PRIORITY_WINS',
    collisionWindow: 43200,
    campaignsCount: 3,
    totalSends: 12450,
            ...
            <div key={group.id} className="card-glow group">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-[var(--border-default)]">
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    <div className="text-lg font-semibold text-[var(--text-primary)]">
                      {group.campaignsCount}
                    </div>
                    <div className="text-xs text-[var(--text-muted)]">Campaigns</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-semibold text-[var(--text-primary)]">
                      {(group.totalSends / 1000).toFixed(1)}K
                    </div>
                    <div className="text-xs text-[var(--text-muted)]">Sends</div>
                  </div>
                </div>
                <div className="flex items-center gap-1">
                  ...
                  <button className="btn btn-ghost p-2 text-rose-400 opacity-0 group-hover:opacity-100 transition-opacity">
