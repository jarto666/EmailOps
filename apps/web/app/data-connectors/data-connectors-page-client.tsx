...
function CreateConnectorModal({
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      if (type === 'BIGQUERY' && (!bigqueryConfig.projectId || !bigqueryConfig.clientEmail || !bigqueryConfig.privateKey)) {
          ...
          {type === 'POSTGRES' && (
            <div>
              ...
              <input
                ...
                onChange={(e) => setPostgresConfig({ connectionString: e.target.value })}
                required
              />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBigqueryConfig((c) => ({ ...c, projectId: e.target.value }))}
                  required
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBigqueryConfig((c) => ({ ...c, clientEmail: e.target.value }))}
                  required
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setBigqueryConfig((c) => ({ ...c, privateKey: e.target.value }))}
                  required
                />
                <p className="text-xs text-[var(--text-muted)] mt-2">
...
export default function DataConnectorsPageClient() {
  ...
  const [connectionStatus, setConnectionStatus] = useState<Record<string, { status: string; error?: string }>>({});
  ...
  const handleTestConnection = async (id: string) => {
    ...
    try {
      ...
      setConnectionStatus((prev) => ({
        ...prev,
        [id]: { status: 'error', error: err instanceof Error ? err.message : 'Connection failed' },
      }));
    } finally {
      setTestingId(null);
    }
              ...
              <div key={connector.id} className="card-glow group">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-[var(--border-default)]">
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <Link href={`/data-connectors/${connector.id}/edit`} className="btn btn-ghost p-2">
